...
for(looprun in 2:5){
  ...
  #SS with no year difference - Year Pooling
  source(file = "BR Model - 3k Execute JAGS.R") 
  source(file = "BR Model - 7k Individual Simulation Results.R")
  
  # #SS with no year difference - Complete Pooling
  source(file = "BR Model - 3l Execute JAGS.R")
  source(file = "BR Model - 7l Individual Simulation Results.R")
  
  #SS with year differences in HR - No Pooling
  source(file = "BR Model - 3i Execute JAGS.R") 
  source(file = "BR Model - 7i Individual Simulation Results.R")
  
  #Simplified SS
  source(file = "BR Model - 3d Execute JAGS.R")
  source(file = "BR Model - 7d Individual Simulation Results.R")
}
