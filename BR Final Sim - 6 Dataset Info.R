...
SimInfo <- SimInfo %>%
  ...
  mutate(Parameter = trialname)
#Save Information
write.csv(SimInfo, file = paste("E:/Maine Drive/Analysis/Band Recovery/FinalSim/",
                                trialname, " - Sim",
                                looprun, " - Data Details.csv", sep = ""), row.names = F)
...
write.csv(mastersiteinfo,
          paste("E:/Maine Drive/Analysis/Band Recovery/FinalSim/", trialname, " - MasterSimInfo.csv", sep = ""), row.names = F)