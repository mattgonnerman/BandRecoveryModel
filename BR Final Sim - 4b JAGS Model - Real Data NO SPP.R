function(){##############################################################################################
  ...
  mean.WMD.HR.A <- mean(HR.A.year)
  mean.WMD.HR.J <- mean(HR.J.year)
  ...
  totalS.A <- S_M_A_W2S * S_M_A_S2W *(1-mean.WMD.HR.A) #
  totalS.J <- S_M_A_W2S * S_M_J_S2W *(1-mean.WMD.HR.J) # J transition to A at 2nd capture season, hence S.A used
  ...
  for(i in 1:N.wmd){
    for(t in 1:n.years){
      ...
      th.A[WMD.id[i],t] ~ dbin(mean.WMD.HR.A, N.A[WMD.id[i],t]) #Temporal Variation in HR
      th.J[WMD.id[i],t] ~ dbin(mean.WMD.HR.J, N.J[WMD.id[i],t]) #Temporal Variation in HR
    }
    ...
    N.A[WMD.id[i],1] ~ dpois((1+th.year1.A[WMD.id[i]])/mean.WMD.HR.A) #Temporal Variation in HR
    N.J[WMD.id[i],1] ~ dpois((1+th.year1.J[WMD.id[i]])/mean.WMD.HR.J) #Temporal Variation in HR
    ...
    for(t in 1:(n.years-1)){
      ...
      n.surv.A[WMD.id[i],t] ~ dbin(totalS.A, N.A[WMD.id[i],t]) #Requires Specific Starting Parameters
      n.surv.J[WMD.id[i],t] ~ dbin(totalS.J, N.J[WMD.id[i],t]) #Requires Specific Starting Parameters
