...
write.csv(BR_w_SPP_output$BUGSoutput$summary, file = "3d_simplifiedSS_output.csv")

#To run extra iterations if did not converge
# recompile(BR_w_SPP_output)
# BR_w_SPP_output.upd <- autojags(BR_w_SPP_output, n.update = 4, Rhat = 1.1, n.iter = 5000, n.thin = 1)
# BR_w_SPP_output
# write.csv(BR_w_SPP_output.upd$BUGSoutput$summary, file = "3d_output.csv")
