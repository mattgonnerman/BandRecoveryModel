...
write.csv(master.bias.hr, "Model Bias Comparison/SampleSize/Master HR Bias.csv", row.names = F)
write.csv(master.bias.wsr, "Model Bias Comparison/SampleSize/Master WSR Bias.csv", row.names = F)
write.csv(master.bias.N, "Model Bias Comparison/SampleSize/Master N Bias.csv", row.names = F)
write.csv(master.bias.R, "Model Bias Comparison/SampleSize/Master R Bias.csv", row.names = F)