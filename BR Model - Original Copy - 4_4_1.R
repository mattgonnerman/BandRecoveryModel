...
setwd("C:/Users/Matt Gonnerman/Google Drive/Analysis/Band Recovery") #at work
setwd("E:/Maine Drive/Analysis/Band Recovery") #at home
...
wmd_boundaries <- readOGR("E:/Maine Drive/GIS/WMD Boundaries", "Maine_Wildlife_Management_Districts")
